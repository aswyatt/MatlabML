...
agentOpts.EpsilonGreedyExploration.Epsilon = .3;
agentOpts.EpsilonGreedyExploration.EpsilonDecay = 1e-3;
agentOpts.EpsilonGreedyExploration.EpsilonMin = eps(0);
...
%	Train the agent
obj = TrainingObj("NumAgents", 5, "LearnRate", .3, "AgentOpts", agentOpts);
obj.Train(100, trainOpts);
